...
namespace WHC.Framework.ControlUtil
{
    ...
    public interface IBaseDAL<T> where T : BaseEntity
    {
        ...
        bool InsertNotLog(T obj, DbTransaction trans = null);
        /// <summary>
        ...
        /// <returns></returns>
        bool UpdateNotLog(T obj, object primaryKeyValue, DbTransaction trans = null);
        ...
        /// <param name="trans"></param>
        /// <returns></returns>
        bool Insert3(T obj, DbTransaction trans = null);

        bool InsertNotLog3(T obj, DbTransaction trans = null);


        bool StoreProcExecute(string storeProcName, Hashtable inParameters = null, Hashtable outParameters = null, DbTransaction trans = null);

        bool StoreProcToResult(string storeProcName, List<DbParameter> intParameters, List<DbParameter> outParameters, DbTransaction trans = null);

        bool ExecStoreProc(string storeProcName, List<SqlParameter> Parameters = null, DbTransaction trans = null);

        DataSet ExecStoreProcToDataSet(string storeProcName, List<SqlParameter> Parameters = null, DbTransaction trans = null);
