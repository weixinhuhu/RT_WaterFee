...
namespace WHC.Framework.ControlUtil
{
    ...
    public class BaseBLL<T> where T : BaseEntity, new()
    {
        ...
        /// <summary>
        /// 调用前检查baseDal是否为空引用WHC.WaterFeeWeb.Core.DALMySql.AccPayment
        /// </summary>WHC.WaterFeeWeb.Core.DALSQL.AccPayment
        ...
        {
            CheckDAL();
            return baseDal.InsertNotLog(obj, trans);
        }
        ...
        {
            CheckDAL();
            return baseDal.Insert3(obj, trans);
        }
        /// <summary>
        /// 插入指定对象到数据库中
        /// </summary>
        ...
        {
            CheckDAL();
            return baseDal.InsertNotLog3(obj, trans);
        }
        ...
        {
            CheckDAL();
            return baseDal.UpdateNotLog(obj, primaryKeyValue, trans);
        }
        ...
        {
            CheckDAL();
            return baseDal.StoreProcExecute(storeProcName, inParameters, outParameters, trans);
        }
        ...
        {
            CheckDAL();
            return baseDal.StoreProcToResult(storeProcName, intParameters, outParameters, trans);
        }

        public bool ExecStoreProc(string storeProcName, List<SqlParameter> Parameters = null, DbTransaction trans = null)
        {
            CheckDAL();
            return baseDal.ExecStoreProc(storeProcName, Parameters, trans);
        ...
        {
            CheckDAL();
            return baseDal.ExecStoreProcToDataSet(storeProcName, Parameters, trans);
        }

        public int GetMaxID(DbTransaction trans = null)
        {
            CheckDAL();
