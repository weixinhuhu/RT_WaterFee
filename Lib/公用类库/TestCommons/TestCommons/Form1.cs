...
using WHC.Framework.Commons.Threading;
...
namespace TestCommons
{
    public partial class Form1 : Form
    {
        ...
        {
            WHC.Framework.Commons.Web.FileServerManage file = new WHC.Framework.Commons.Web.FileServerManage("http://10.88.1.30:8009", "administrator", "123456789");
            try
            {
                //上传文件
                bool first = false;
        ...
        {
            WHC.Framework.Commons.Threading.Timer timer = new WHC.Framework.Commons.Threading.Timer(1000, true);
        ...
        private void btnSmtpMail_Click(object sender, EventArgs e)
        {
            ...
            ArrayList list = mail.ReceiveMail("wuhuacong@163.com", "123456");
