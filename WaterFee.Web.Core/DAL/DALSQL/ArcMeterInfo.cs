...
{
    public partial class ArcMeterInfo : WHC.Framework.ControlUtil.BaseDALSQL<Entity.ArcMeterInfo>, IArcMeterInfo
    {
        #region 对象实例及构造函数
        ...
        public ArcMeterInfo() : base("ArcMeterInfo", "IntID",true)
        {
        }
