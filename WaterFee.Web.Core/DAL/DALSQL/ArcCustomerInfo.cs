...
{
    public partial class ArcCustomerInfo : WHC.Framework.ControlUtil.BaseDALSQL<Entity.ArcCustomerInfo>, IArcCustomerInfo
    {
        #region 对象实例及构造函数
        ...
        public ArcCustomerInfo() : base("ArcCustomerInfo", "IntID",true)
        {
        }
