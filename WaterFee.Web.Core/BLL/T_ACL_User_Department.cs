...
{
    public class T_ACL_User_Department : WHC.Framework.ControlUtil.BaseBLL<Entity.T_ACL_User_Department>
    {
        public T_ACL_User_Department() : base()
        {
        ...
        //{
        //    var sql = "select Max(intNo) from T_ACL_User_Department";
