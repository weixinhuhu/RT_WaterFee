...
{
    public class PriceComposition : WHC.Framework.ControlUtil.BaseBLL<Entity.PriceComposition>
    {
        public PriceComposition() : base()
        {
        ...
        public int GetMaxIntNo(System.Data.Common.DbTransaction trans = null)
        {
            ...
            var sql = "select Max(intNo) from PriceComposition";
