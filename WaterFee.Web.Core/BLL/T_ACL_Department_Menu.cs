...
{
    public class T_ACL_Department_Menu : WHC.Framework.ControlUtil.BaseBLL<Entity.T_ACL_Department_Menu>
    {
        public T_ACL_Department_Menu() : base()
        {
        ...
        //{
        //    var sql = "select Max(intNo) from T_ACL_Department_Menu";
